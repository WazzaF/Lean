...
namespace QuantConnect.Algorithm.Framework.Portfolio
{
    ...
    public class BlackLittermanOptimizationPortfolioConstructionModel : PortfolioConstructionModel
    {
        ...
        {
            return FilterInvalidInsightMagnitude(Algorithm, new []{ insight }).Any();
        }
        ...
        protected override Dictionary<Insight, double> DetermineTargetPercent(ICollection<Insight> lastActiveInsights)
        {
